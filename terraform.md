...
We should now be able to build and access our first server.  This will be a bastion server residing in the DMZ.  Oh, wait, first we need to confirm the status of our [golden image](/blog/windows).
